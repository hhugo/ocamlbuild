...
module Indirect : sig
val prepare_compile : Pathname.t -> unit Rule.action_result
val compile_ocaml_interf : string -> string -> Rule.indirect_action
val byte_compile_ocaml_interf : string -> string -> Rule.indirect_action
val byte_compile_ocaml_implem : ?tag:string -> string -> string -> Rule.indirect_action
val prepare_link :
  Pathname.t -> Pathname.t ->
  string list -> unit Rule.action_result
val native_compile_ocaml_implem : ?tag:string -> ?cmx_ext:string -> string -> Rule.indirect_action
val prepare_libs :
  string -> string -> Pathname.t ->
  Pathname.t list Rule.action_result
val link_gen :
  string -> string -> string -> string list ->
  (Tags.t -> Pathname.t list -> Pathname.t -> Command.t) ->
  (Tags.t -> Tags.t) ->
  string -> string -> Rule.indirect_action
val byte_link : string -> string -> Rule.indirect_action
val byte_output_obj : string -> string -> Rule.indirect_action
val byte_library_link : string -> string -> Rule.indirect_action
val byte_debug_link : string -> string -> Rule.indirect_action
val byte_debug_library_link : string -> string -> Rule.indirect_action
val native_link : string -> string -> Rule.indirect_action
val native_output_obj : string -> string -> Rule.indirect_action
val native_library_link : string -> string -> Rule.indirect_action
val native_shared_library_link : ?tags:(string list) -> string -> string -> Rule.indirect_action
val native_profile_link : string -> string -> Rule.indirect_action
val native_profile_library_link : string -> string -> Rule.indirect_action
val link_modules :
  (Pathname.t * string list) list ->
  string -> string ->
  string -> (Tags.t -> Pathname.t list -> Pathname.t -> Command.t) ->
  (Tags.t -> Tags.t) ->
  string list -> string -> Rule.indirect_action
val pack_modules :
  (Pathname.t * string list) list ->
  string -> string ->
  string -> (Tags.t -> Pathname.t list -> Pathname.t -> Command.t) ->
  (Tags.t -> Tags.t) ->
  string list -> string -> Rule.indirect_action
val byte_library_link_modules : string list -> string -> Rule.indirect_action
val byte_library_link_mllib : string -> string -> Rule.indirect_action
val byte_debug_library_link_modules : string list -> string -> Rule.indirect_action
val byte_debug_library_link_mllib : string -> string -> Rule.indirect_action
val byte_pack_modules : string list -> string -> Rule.indirect_action
val byte_pack_mlpack : string -> string -> Rule.indirect_action
val byte_debug_pack_modules : string list -> string -> Rule.indirect_action
val byte_debug_pack_mlpack : string -> string -> Rule.indirect_action
val byte_toplevel_link_modules : string list -> string -> Rule.indirect_action
val byte_toplevel_link_mltop : string -> string -> Rule.indirect_action
val native_pack_modules : string list -> string -> Rule.indirect_action
val native_pack_mlpack : string -> string -> Rule.indirect_action
val native_library_link_modules : string list -> string -> Rule.indirect_action
val native_library_link_mllib : string -> string -> Rule.indirect_action
val native_shared_library_link_modules : string list -> string -> Rule.indirect_action
val native_shared_library_link_mldylib : string -> string -> Rule.indirect_action
val native_profile_pack_modules : string list -> string -> Rule.indirect_action
val native_profile_pack_mlpack : string -> string -> Rule.indirect_action
val native_profile_library_link_modules : string list -> string -> Rule.indirect_action
val native_profile_library_link_mllib : string -> string -> Rule.indirect_action
val native_profile_shared_library_link_modules : string list -> string -> Rule.indirect_action
val native_profile_shared_library_link_mldylib : string -> string -> Rule.indirect_action
end
